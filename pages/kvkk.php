...
$basePath = '../';
$pageTitle = 'KVKK Aydınlatma Metni - Gebze Belediyesi';
...
$stmt = $conn->query("SELECT icerik FROM sayfa_kvkk LIMIT 1");
...
<main class="kurumsal-bolumu page-content">
    <div class="container">
        <div class="kurumsal-grid">
            ...
            <?php $currentPage = 'kvkk'; include '../includes/kurumsal-sidebar.php'; ?>
        </div>
    </div>
</main>
