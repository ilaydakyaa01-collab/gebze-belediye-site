...
<style>
    ...
    /* Başkan ikonunun arkasındaki mavi arka planı kaldırma
       (harici css'teki .yonetim-icon-buyuk kuralını eziyor) */
    .yonetim-icon-buyuk {
        ...
        <div class="yonetim-arac-cubugu">
            ...
            <div class="yonetim-kurumsal-menu">
                ...
                <div class="kurumsal-dropdown" id="kurumsalDropdown" hidden>
                    ...
                    <a href="<?php echo $basePath; ?>pages/kurumsal/eski-baskanlar.php">Eski Başkanlar</a>
