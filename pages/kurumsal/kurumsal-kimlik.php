...
<section class="kk-bolumu page-content">
    <div class="container">
        ...
        <div class="kk-layout">
            <div>
                <nav class="kk-filtre">
                    <a href="<?php echo $basePath; ?>pages/kurumsal/kurumsal-kimlik.php" class="<?php echo $secilenKategori === '' ? 'is-active' : ''; ?>">Tümü</a>
                    <?php foreach ($kategoriler as $kat): ?>
                        <a href="<?php echo $basePath; ?>pages/kurumsal/kurumsal-kimlik.php?kategori=<?php echo urlencode($kat); ?>" class="<?php echo $secilenKategori === $kat ? 'is-active' : ''; ?>"><?php echo htmlspecialchars($kat); ?></a>
                    <?php endforeach; ?>
                </nav>
